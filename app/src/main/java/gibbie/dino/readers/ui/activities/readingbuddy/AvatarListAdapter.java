...
public class AvatarListAdapter extends RecyclerView.Adapter<AvatarListAdapter.DataViewHolder>{
    ...
    public AvatarListAdapter(Context mCtx, List<ReadingBuddyAvatarModel> avatarList, ImageView iv_selected_avatar, TextView tv_name) {
        this.mCtx = mCtx;
    ...
    public DataViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.avatar_list_item, parent,false);
    ...
    public void onBindViewHolder(@NonNull DataViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.iv_avatar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tv_name.setText(selectedName);
                notifyDataSetChanged();
                ((PickAvatarBuddyActivity)mCtx).checkAvatarSelection();
            }
        });
    }
